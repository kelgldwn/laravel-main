...
<body class="bg-gray-50 font-sans overflow-hidden">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="relative">
                                ...
                                <div class="border-2 border-gray-200 rounded-xl p-4 cursor-pointer hover:border-blue-500 transition-colors role-option">
                            ...
                            <label class="relative">
                                <input type="radio" name="role" value="trainer" class="sr-only">
                                <div class="border-2 border-gray-200 rounded-xl p-4 cursor-pointer hover:border-orange-500 transition-colors role-option">
                                    <div class="text-center">
                    ...
                    @if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())
                        <div class="flex items-start">
                            ...
                            <label for="terms" class="ml-2 block text-sm text-gray-700">
                                I agree to the 
                                <a target="_blank" href="{{ route('terms.show') }}" class="text-blue-600 hover:text-blue-500 font-medium">Terms of Service</a>
                                and 
                                <a target="_blank" href="{{ route('policy.show') }}" class="text-blue-600 hover:text-blue-500 font-medium">Privacy Policy</a>
                            </label>
                        </div>
                    @endif
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            roleOptions.forEach((option, index) => {
                option.addEventListener('click', function() {
                    ...
                    roleOptions.forEach(opt => {
                        opt.classList.remove('border-blue-500', 'border-orange-500', 'bg-blue-50', 'bg-orange-50');
            ...
            // Set initial state
            roleOptions[0].classList.add('border-blue-500', 'bg-blue-50');
            roleOptions[0].classList.remove('border-gray-200');
